% plot_a_processed_qso_full_int.m : plot sample of spectrum with model dla
...
this_mu1 = dla_mu( ind_1);
this_mu2 = dla_mu(~ind_1);
this_M1  = dla_M( ind_1, :);
this_M2  = dla_M(~ind_1, :);
...
hold on
    ...
    s = scatter(tau_0_samples(i), beta_samples(i), 80, 'b', 'filled', 'd', 'DisplayName', 'MAP predictions');
    ...
    ylim([beta_mu - 4*beta_sigma beta_mu + 4*beta_sigma])
